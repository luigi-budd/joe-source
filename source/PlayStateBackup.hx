	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'he sounds exactly like': //he sounds exactly like endless its scary 😲😲😨😨
				...
				GameOverSubstate.characterName = 'DEADheadSetBOYFRIEND';

				var endless:BGSprite = new BGSprite('stupid/endles', -51, -88, 1.2, 1.3);
			...
			case 'BETAjoeStudio':
				...
				var oldStudioSlider:BGSprite = new BGSprite('oldStudio/slider', -296.95, -223.5, .9, .9);
